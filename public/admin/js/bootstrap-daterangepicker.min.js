...
!(function (a) {
  typeof define === 'function' && define.amd
    ? define(['jquery'], a)
    : a(typeof exports === 'object' ? require('jquery') : jQuery)
})(function (a, b) {
  function c () {
      ...
      var b = {
        ...
        contains: function (a) {
          for (var b = a && a.valueOf(), c = 0, d = this.length; c < d; c++) {
            if (this[c].valueOf() - b >= 0 && this[c].valueOf() - b < 864e5) { return c }
          }
          return -1
        },
        remove: function (a) {
  ...
  k.prototype = {
      ...
      this.element.trigger({
        ...
        format: a.proxy(function (a, b) {
          arguments.length === 0
            ...
            : typeof a === 'string' && ((b = a), (a = this.dates.length - 1)),
          (b = b || this.o.format)
    ...
    paste: function (b) {
      ...
      ) { c = b.originalEvent.clipboardData.getData('text/plain') } else {
    ...
    place: function () {
      ...
      var b = this.picker.outerWidth(),
        ...
        f = e.width(),
        g =
          this.o.container === 'body' ? a(document).scrollTop() : e.scrollTop(),
        h = e.offset(),
        i = [0]
      this.element.parents().each(function () {
        var b = a(this).css('z-index')
        b !== 'auto' && Number(b) !== 0 && i.push(Number(b))
      })
      ...
      if (
        (q === 'auto' && ((p = -g + o - c), (q = p < 0 ? 'bottom' : 'top')),
    ...
    click: function (b) {
      ...
      e.hasClass('today') &&
          !e.hasClass('day') &&
          (this.setViewMode(0),
          this._setDate(d(), this.o.todayBtn === 'linked' ? null : 'view')),
    ...
    navArrowsClick: function (b) {
      ...
      this.viewMode !== 0 && (d *= 12 * r.viewModes[this.viewMode].navStep),
    ...
    _setDate: function (a, b) {
      ;(b && b !== 'date') || this._toggle_multidate(a && new Date(a)),
      ((!b && this.o.updateViewDate) || b === 'view') &&
          (this.viewDate = a && new Date(a)),
      this.fill(),
      this.setValue(),
      (b && b === 'view') || this._trigger('changeDate'),
      this.inputField.trigger('change'),
      !this.o.autoclose || (b && b !== 'date') || this.hide()
    },
      ...
      switch (a.keyCode) {
        ...
        case 40:
          if (
            ...
            break
          }(b = a.keyCode === 37 || a.keyCode === 38 ? -1 : 1),
          this.viewMode === 0
            ? a.ctrlKey
  ...
  var q = (a.fn.datepicker.dates = {
    ...
    r = {
      ...
      parseFormat: function (a) {
        if (typeof a.toValue === 'function' && typeof a.toDisplay === 'function') { return a }
      ...
      parseDate: function (c, e, f, g) {
        ...
        if ((typeof e === 'string' && (e = r.parseFormat(e)), e.toValue)) { return e.toValue(c, e, f) }
        var j,
          l,
          m,
          n,
      ...
      formatDate: function (b, c, d) {
        if (!b) return ''
        if ((typeof c === 'string' && (c = r.parseFormat(c)), c.toDisplay)) { return c.toDisplay(b, c, d) }
        var e = {
          d: b.getUTCDate(),
